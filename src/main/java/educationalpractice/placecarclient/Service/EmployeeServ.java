...
import static educationalpractice.placecarclient.MainApplication.fifa;
...
public class EmployeeServ {
    ...
    public void findById(Employee data) {
        ...
        if (response.isSuccess()) {
            ...
            fifa.setSurname(data.getSurname());
            fifa.setLastname(data.getLastname());
            fifa.setName(data.getName());
        } else {
